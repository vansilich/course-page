...
var FormHandler = /*#__PURE__*/function () {
  function FormHandler(form_selector, inputs_and_rules, input_error_class, error_bag_selector) {
    ...
    value: function assignInputsHandlers() {
      ...
      this.forms.forEach(function (form) {
        ...
        form.addEventListener('submit', function (event) {
          ...
          _this.flushErrorBag(formErrorBag);
          ...
          _this.handleFormSubmit(form, event);
        });
      });
    }
  }, {
...
}, 'error', '.popup-apply-form__errors');
