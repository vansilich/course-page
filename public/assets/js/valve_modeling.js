...
new _modules_burger_menu_toggle__WEBPACK_IMPORTED_MODULE_2__["default"]('.top-nav__burger-menu-icon', '.top-nav__burger-menu', 'open', '.nav-burger-menu__close', '.popup-overlay.nav-burger-menu-overlay'); // Popup по открытию кнопки из навигации

new _modules_popup__WEBPACK_IMPORTED_MODULE_5__["default"]('.top-nav__button', '.popup-apply-form-overlay', 'hidden'); // Popup по открытию кнопки из мобильного меню

new _modules_popup__WEBPACK_IMPORTED_MODULE_5__["default"]('.nav-mobile-enroll-btn', '.popup-apply-form-overlay', 'hidden');
